...
def conversie_operator(operator_de_convertit: bool, valoare_de_convertit: str) -> float:
...
def functie_diferenta(numar_1: float, numar_2: float) -> str:
    rezultat = "Diferenta nu se poate realita"
    if numar_1 and numar_2:
        rezultat = f"{numar_1} - {numar_2} = {numar_1 - numar_2}"
    return rezultat
#de rezolvat inmultirea si impartirea .... posibil
