...
# daca aceste litere se repeta in intervalul cuvantului atunci sunt si ele vizibile
...
while numar_vieti > 0:
    ...
    # daca utilizatorul introduce mai multe caractere, afisam pe ecran o eroare
    if len(litera) > 1 or litera in '0123456789':
        print("Introduceti o singura litera si nu cifre")
        continue
    elif litera in cuvant:
        # daca litera se fla in cuvant, atunci o inloicuim
