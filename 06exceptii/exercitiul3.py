"""
Sa se acceseze o valoare intr-un dictionar dupa cheia specificara de utilizator.
...
try:
    cheie = input("Introduceti angajatul pentru care doriti sa vizualizati numar de zile de concediu: ")
